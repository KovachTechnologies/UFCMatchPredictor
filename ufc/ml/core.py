...
DATA_PATH = PROJECT_ROOT / "data" / "features_core.csv"
...
def train_model_and_save():
    ...
    # Persist model
    model_out = PROJECT_ROOT / "data" / "ufc_xgb_light_pipeline.joblib"
...
def apply_model() :
    ...
    model_file = PROJECT_ROOT / "data" / "ufc_xgb_light_pipeline.joblib"
    ...
    output_filename = f"{dt_string}_predictions.csv"
